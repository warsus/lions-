...
\bd
\item[(a)] the static variable ``p'' \url{./v6/ken/``\href{./v6/ken/{slp.c}{slp.c}''#L265}
declared in ``swtch'' \url{./v6/ken/``\href{./v6/ken/{slp.c}{slp.c}''#L263} which is
...
``swbuf'' \url{./v6/dmr/bio.c#L22} which are referenced 
...
\bd
\item[param.h] \url{./v6/param.h} [Sheet 01] contains no variable 
...
\item[systm.h] \url{./v6/systm.h} [Sheet 02; Chapter 19] consists 
entirely of declarations (with
definitions of the structures ``callout'' \url{./v6/systm.h#L29}
and ``mount'' \url{./v6/systm.h#L40} as side-effects).
...
``includes'' ``\href{./v6/systm.h}{systm.h}'' must have
previously included ``\href{./v6/param.h}{param.h}''.

\item[seg.h] \url{./v6/seg.h} [Sheet 03] contains a few
definitions and one declaration,
which are used for referencing the
segmentation registers. This file
could be absorbed into ``\href{./v6/param.h}{param.h}'' and
``\href{./v6/systm.h}{systm.h}'' without any real loss.

\item[proc.h] \url{./v6/ken/proc.h} [Sheet 03; Chapter 7] contains 
the important declaration for
``\href{./v6/proc.h#L26}{proc}'' \url{./v6/ken/proc.h#L0358} which is both a structure
...
elements, ``p\_stat'' \url{./v6/ken/proc.h#L0381} and ``p\_flag'' \url{./v6/ken/proc.h#L0391}
have individual names which are
define.


\item[user.h] \url{./v6/ken/user.h} [Sheet 04; Chapter 7] contains 
the declaration for the very
important ``user'' \url{./v6/ken/user.h#L0413} structure, plus a
set of defined values for ``u\_error'' \url{./v6/ken/user.h#L0430}.
...
\bd
\item[low.s] \url{./v6/ken/low.s} [Sheet 05, Chapter 9] contains
...
\item[m40.s] \url{./v6/ken/m40.s} [Sheets 06..14; Chapters 6, 8,
...
\bd
\item[``\href{./v6/ken/{main.c}{main.c}''] \url{./v6/ken/``\href{./v6/ken/{main.c}{main.c}''} [Sheets 15..17; Chapters 6,
7] contains ``main'' \url{./v6/ken/``\href{./v6/ken/{main.c}{main.c}''#L1550} which performs
various initialisation tasks to get
UNIX running. It also contains
``sureg'' \url{./v6/ken/``\href{./v6/ken/{main.c}{main.c}''#L1739} and ``estabur'' \url{./v6/ken/``\href{./v6/ken/{main.c}{main.c}''#L1650} which set the
user segmentation registers.


\item[``\href{./v6/ken/{slp.c}{slp.c}''] \url{./v6/ken/``\href{./v6/ken/{slp.c}{slp.c}''} [Sheets 18..22; Chapters 6, 7,
8, 14] contains the major procedures
required for process management
including ``newproc'' \url{./v6/ken/``\href{./v6/ken/{slp.c}{slp.c}''#L1826}, ``sched'' \url{./v6/ken/``\href{./v6/ken/{slp.c}{slp.c}''#L1940},
``sleep'' \url{./v6/ken/``\href{./v6/ken/{slp.c}{slp.c}''#L2066} and ``swtch'' \url{./v6/ken/``\href{./v6/ken/{slp.c}{slp.c}''#L2178}.


\item[``\href{./v6/ken/{prf.c}{prf.c}''] \url{./v6/ken/``\href{./v6/ken/{prf.c}{prf.c}''} [Sheets 23, 24; Chapter 5]
contains ``panic'' \url{./v6/ken/``\href{./v6/ken/{prf.c}{prf.c}''#L2419} and a number of
other procedures which provide a
simple mechanism for displaying initialisation 
messages and error messages 
to the operator.

\item[``\href{./v6/ken/{malloc.c}{malloc.c}''] \url{./v6/ken/``\href{./v6/ken/{malloc.c}{malloc.c}''} [Sheet 25; Chapter 5] contains 
``malloc'' \url{./v6/ken/``\href{./v6/ken/{malloc.c}{malloc.c}''#L2528} and ``mfree'' \url{./v6/ken/``\href{./v6/ken/{malloc.c}{malloc.c}''#L2556} which are
...
\bd
\item[reg.h] \url{./v6/ken/reg.h} [Sheet 26; Chapter 10] defines
a set of constants which are used in
referencing the previous user mode
register values when they are stored
in the kernel stack.

\item[``\href{./v6/ken/{trap.c}{trap.c}''] \url{./v6/ken/``\href{./v6/ken/{trap.c}{trap.c}''} [Sheets 26..28; Chapter 12]
contains the ``C'' procedure ``trap'' \url{./v6/ken/``\href{./v6/ken/{trap.c}{trap.c}''#L2693}
which recognises and handles traps
of various kinds.

\item[``\href{./v6/ken/{sysent.c}{sysent.c}''] \url{./v6/ken/``\href{./v6/ken/{sysent.c}{sysent.c}''} [Sheet 29; Chapter 12] contains 
the declaration and initialisation 
of the array ``sysent'' \url{./v6/ken/``\href{./v6/ken/{sysent.c}{sysent.c}''#L2975} which
is used by ``trap'' \url{./v6/ken/``\href{./v6/ken/{trap.c}{trap.c}''#L2693} to associate the
appropriate kernel mode routine with
each system call type.

\item[sysl.c] \url{./v6/ken/``\href{./v6/ken/{sys1.c}{sys1.c}''} [Sheets 30..33; Chapters 12,
13] contains various routines associated 
with system calls, including
``exec'' \url{./v6/ken/``\href{./v6/ken/{sys1.c}{sys1.c}''#L3020} ``exit'' \url{./v6/ken/``\href{./v6/ken/{sys1.c}{sys1.c}''#L3219} ``wait'' \url{./v6/ken/``\href{./v6/ken/{sys1.c}{sys1.c}''#L3270} and ``fork'' \url{./v6/ken/``\href{./v6/ken/{sys1.c}{sys1.c}''#L3322}.

\item[``\href{./v6/ken/{sys4.c}{sys4.c}''] \url{./v6/ken/``\href{./v6/ken/{sys4.c}{sys4.c}''} [Sheets 34..36; Chapters 12,
13, 19] contains routines for
``unlink'' \url{./v6/ken/``\href{./v6/ken/{sys4.c}{sys4.c}''#L3510}, ``kill'' \url{./v6/ken/``\href{./v6/ken/{sys4.c}{sys4.c}''#L3630} and various other
minor system calls.

\item[``\href{./v6/ken/{clock.c}{clock.c}''] \url{./v6/ken/``\href{./v6/ken/{clock.c}{clock.c}''} [Sheets 37, 38; Chapter 11]
contains ``clock'' \url{./v6/ken/``\href{./v6/ken/{clock.c}{clock.c}''#L3725} which is the
handler for clock interrupts, and
which does much of the incidental
housekeeping and basic accounting.

\item[``\href{./v6/ken/{sig.c}{sig.c}''] \url{./v6/ken/``\href{./v6/ken/{sig.c}{sig.c}''} [Sheets 39..42; Chapter 13]
...
\bd
\item[text.h] \url{./v6/ken/text.h} [Sheet 43; Chapter 14]
defines the ``text'' \url{./v6/ken/text.h#L4306} structure and
array. One ``text'' structure is used
to define the status of a shared
text segment.

\item[``\href{./v6/ken/{text.c}{text.c}''] [Sheets 43, 44; Chapter 14]
...
\item[bio.c] \url{./v6/ken/bio.c} [Sheets 47..53; Chapters 15,
...
\item[rk.c] \url{./v6/ken/rk.c} [Sheets 53, 54; Chapter 16] is
...
\bd
\item[file.h] \url{./v6/ken/file.h} [Sheet 55; Chapter 18]
defines the ``file'' \url{./v6/ken/file.h#L5507} structure and
array.

\item[filsys.h] \url{./v6/ken/filsys.h} [Sheet 55; Chapter 20]
defines the ``filsys'' \url{./v6/ken/filsys.h#L5561} structure which
is copied to and from the ``super
block'' on ``mounted'' file systems.


\item[ino.h] \url{./v6/ken/ino.h} [Sheet 56] describes the
...
\item[inode.h] \url{./v6/ken/inode.h} [Sheet 56; Chapter 18]
defines the ``inode'' \url{./v6/ken/inode.h#L5659} structure and
array. ``inodes'' are of fundamental
importance in managing the accesses
of processes to files.

\item[``\href{./v6/ken/{sys2.c}{sys2.c}''] \url{./v6/ken/``\href{./v6/ken/{sys2.c}{sys2.c}''} [Sheets 57..59; Chapters 18,
19] contains a set of routines associated
with system calls including
``read'' \url{./v6/ken/``\href{./v6/ken/{sys2.c}{sys2.c}''#L5711}, ``write'' \url{./v6/ken/``\href{./v6/ken/{sys2.c}{sys2.c}''#L5720}, ``creat'' \url{./v6/ken/``\href{./v6/ken/{sys2.c}{sys2.c}''#L5781}, ``open'' \url{./v6/ken/``\href{./v6/ken/{sys2.c}{sys2.c}''#L5763} and
``close'' \url{./v6/ken/``\href{./v6/ken/{sys2.c}{sys2.c}''#L5846}
 
\item[``\href{./v6/ken/{sys3.c}{sys3.c}''] \url{./v6/ken/``\href{./v6/ken/{sys3.c}{sys3.c}''} [Sheets 60, 61; Chapters 19, 20]
contains a set of routines associated
with various minor system
calls.
 
\item[``\href{./v6/ken/{rdwri.c}{rdwri.c}''] \url{./v6/ken/``\href{./v6/ken/{rdwri.c}{rdwri.c}''} [Sheets 62, 63; Chapter 18]
contains intermediate level routines
involved with reading and writing
files.
 
 
\item[``\href{./v6/ken/{subr.c}{subr.c}''] \url{./v6/ken/``\href{./v6/ken/{subr.c}{subr.c}''} [Sheets 64, 65; Chapter 18]
contains more intermediate level
routines for i/o, especially ``bmap'' \url{./v6/ken/``\href{./v6/ken/{subr.c}{subr.c}''#L6415}
which translates logical file
pointers into physical disk
addresses.

\item[``\href{./v6/ken/{fio.c}{fio.c}''] \url{./v6/ken/``\href{./v6/ken/{fio.c}{fio.c}''} [Sheets 66..6; Chapters 18,
19] contains intermediate level routines 
for file opening, closing and
control of access.

\item[``\href{./v6/ken/{alloc.c}{alloc.c}''] \url{./v6/ken/``\href{./v6/ken/{alloc.c}{alloc.c}''} [Sheets 69..72; Chapter 20]
contains procedures which manage the
allocation of entries in the ``inode''
array and of blocks of disk storage.

\item[``\href{./v6/ken/{iget.c}{iget.c}''] \url{./v6/ken/``\href{./v6/ken/{iget.c}{iget.c}''} [Sheets 72..74; Chapters 18,
19, 20] contains procedures concerned 
with referencing and updating
``inodes''.

\item[``\href{./v6/ken/{nami.c}{nami.c}''] \url{./v6/ken/``\href{./v6/ken/{nami.c}{nami.c}''} [Sheets 75, 76; Chapter 19]
contains the procedure ``namei'' \url{./v6/ken/``\href{./v6/ken/{nami.c}{nami.c}''#L7518} which
searches the file directories.


\item[``\href{./v6/ken/{pipe.c}{pipe.c}''] \url{./v6/ken/``\href{./v6/ken/{pipe.c}{pipe.c}''} [Sheets 77, 78; Chapter 21]
...
\bd
\item[tty.h] \url{./v6/ken/tty.h} [Sheet 79; Chapters 23, 24]
defines the ``clist'' \url{./v6/ken/tty.h#L7908} structure (used
as a list head for character buffer
queues), the ``tty'' \url{./v6/ken/tty.h#L7926} structure (stores
...
\item[pc.c] \url{./v6/ken/pc.c} [Sheets 86,87; Chapter 22] is
the device handler for the PC11
paper tape reader/punch controller.

\item[lp.c] \url{./v6/ken/lp.c} [Sheets 88, 89; Chapter 22] is
the device handler for the LP11 line
printer controller.

\item[mem.c] \url{./v6/ken/mem.c} [Sheet 90] contains procedures
