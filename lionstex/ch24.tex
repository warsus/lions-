...
single file ````\href{./v6/dmr/tty.c}{tty.c}'''', to be found on
Sheets 81 to 85. A set of common definitions is gathered in the file ``\href{./v6/tty.h}{tty.h}''
on Sheet 79.

By way of example, Sheet 80 contains
the file ````\href{./v6/dmr/kl.c}{kl.c}'''', which constitutes the
...
The file ````\href{./v6/dmr/kl.c}{kl.c}'''' constitutes the device
...
and recomiling ````\href{./v6/dmr/kl.c}{kl.c}'''', and relinking
the operaing system.
...
the code in the files ````\href{./v6/dmr/kl.c}{kl.c}'''' (Sheet 80)
and ````\href{./v6/dmr/tty.c}{tty.c}'''' (Sheets 81 to 85). We
