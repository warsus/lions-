...
during his perusal of the file ````\href{./v6/dmr/tty.c}{tty.c}''''.
...
````\href{./v6/dmr/lp.c}{lp.c}'''' (Sheets 88, 89). Much of the
...
is explicitly manipulated in ````\href{./v6/dmr/lp.c}{lp.c}''''.
...
This driver is to be found in the file
````\href{./v6/dmr/pc.c}{pc.c}'''' on Sheets 86, 87. It is simpler
