...
exception ``\href{./v6/ken/{trap c}{trap c}''an be expected occasionally and is the concern of the
...
reviewed in the file ````\href{./v6/ken/{sysent.c}{sysent.c}'''' on
...
``sysl.c'', ``\href{./v6/ken/{sys2.c}{sys2.c}''``, ``\href{./v6/ken/{sys3.c}{sys3.c}'''' and
````\href{./v6/ken/{sys4.c}{sys4.c}''''.

Two important ``trivial'' procedures are
``nullsys'' (2855) and ``nosys'' (2864)
which are found in the file ````\href{./v6/ken/{trap.c}{trap.c}''''.
...
\sbs{The Files ```\href{./v6/ken/{sys2.c}{sys2.c}''' and ```\href{./v6/ken/{sys3.c}{sys3.c}'''}

````\href{./v6/ken/{sys2.c}{sys2.c}'''' and ````\href{./v6/ken/{sys3.c}{sys3.c}'''' are mainly concerned with the file system and
input/output, and they have been
relegated to Section Four of the
operating system source code.


\sbs{The File ```\href{./v6/ken/{sys4.c}{sys4.c}'''}
