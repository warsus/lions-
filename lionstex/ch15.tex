...
The file ``\href{./v6/conf.h}{conf.h}'' declares:
...
dimensioned or initialised in ``\href{./v6/conf.h}{conf.h}''.
...
the file ````\href{./v6/dmr/bio.c}{bio.c}'''', it will be instructive as well as convenient to examine
