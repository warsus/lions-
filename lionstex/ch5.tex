...
\subsection{The File ```\href{./v6/ken/{malloc.c}{malloc.c}'''}
...
\subsection{The File ```\href{./v6/ken/{prf.c}{prf.c}'''}
...
if the file ``\href{./v6/param.h}{param.h}'' had not been
``included'' in ````\href{./v6/ken/{prf.c}{prf.c}''''.

The files ``\href{./v6/buf.h}{buf.h}'' and ``\href{./v6/conf.h}{conf.h}'' have
...
fourth file, ``\href{./v6/seg.h}{seg.h}'', is a little
...
``integ'' from ``\href{./v6/seg.h}{seg.h}'' to ``\href{./v6/param.h}{param.h}''.
Q.E.D.

Note that the variable ``panicstr''
(2328) is also global but since it is
not referenced outside ````\href{./v6/ken/{prf.c}{prf.c}'''', its
